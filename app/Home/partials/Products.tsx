...
export default function Products() {
  ...
  return (
    <section
      id="products"
      className="relative bg-[#060315] overflow-hidden py-24 lg:py-32"
      ref={ref}
    >
      {/* Background dot grid */}
      <div
      ...
      />
      {/* Glow accents */}
      <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-[#FF3E41]/8 blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[#FF3E41] font-mono text-xs tracking-[0.3em] uppercase">Supply Catalog</span>
            </div>
          ...
          <p className="text-white/50 text-sm max-w-sm leading-relaxed font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {PRODUCTS.map((product, i) => (
            <motion.div
              ...
              className="group relative bg-white/5 hover:bg-white/8 border border-white/10 hover:border-[#FF3E41]/40 rounded-2xl p-7 transition-all duration-400 overflow-hidden cursor-pointer"
            >
              {/* Glow on hover */}
              ...
              <div className="relative">
                {/* Tag */}
                <div className="font-mono text-[9px] text-[#51CFED]/50 tracking-[0.3em] mb-5 uppercase">
                  {product.tag}
                </div>

                {/* Icon */}
                <div className="w-12 h-12 rounded-xl bg-[#FF3E41]/10 border border-[#FF3E41]/20 flex items-center justify-center mb-5 group-hover:bg-[#FF3E41]/20 group-hover:border-[#FF3E41]/50 transition-all duration-300">
                  <product.icon className="w-5 h-5 text-[#FF3E41]" />
                </div>

                <h3 className="font-bold text-white text-base leading-snug mb-3 group-hover:text-[#51CFED] transition-colors">
                  {product.title}
                </h3>
                ...
                {/* Arrow on hover */}
                <div className="mt-5 flex items-center gap-2 text-[#FF3E41] opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#FF3E41] hover:bg-[#e63538] text-white font-bold text-sm tracking-widest uppercase rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-[#FF3E41]/30"
          >
            Request a Quotation
